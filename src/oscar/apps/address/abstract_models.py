...
class AbstractAddress(models.Model):
    ...
    line4 = models.ForeignKey('rajaongkir_cities.RajaongkirCity', verbose_name=_('City'))
    ...
    country = models.ForeignKey('address.Country', verbose_name=_("Country"), null=True, blank=True)
    ...
    def active_address_fields(self, include_salutation=True):
        ...
        fields = [self.line1, self.line2, self.line3,
                  self.line4.city_name, self.state, self.postcode]
...
class AbstractShippingAddress(AbstractAddress):
    ...
    phone_number = models.CharField(
        _("Phone number"), blank=True, max_length=30,
